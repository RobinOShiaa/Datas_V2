...
def scrape():
    ...
    for flow_id in flows:
        ...
        if flows[flow_id] == 'imports':
            dropdown_texts.insert(0, ['0150AT', 'Cheese'])
            dropdown_texts.insert(0, ['0155AT', 'Other Dairy Products'])
        else:
            dropdown_texts.insert(0, ['0170AT', 'Dairy Products'])
        ...
        dir_path = create_directory(WEB_USDA_PATH, 'trade_flow_monthly_dairy/title_options')
