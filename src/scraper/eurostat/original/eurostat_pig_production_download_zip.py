...
profile.set_preference('browser.download.dir', 'C:\\Dropbox\\ProgramData\\eclipse-jee-luna\\DATAS_Code\\Pig_Scraper\\output')
profile.set_preference('browser.helperApps.neverAsk.saveToDisk', 'application/zip, application/x-zip, application/x-zip-compressed, application/download, application/octet-stream')
...
button_click('//input[@id="csvFULL_EXTRACTION"]', 'xpath')

'''
browser.profile.set_preference('browser.download.folderList', 2) # custom location
browser.profile.set_preference('browser.download.manager.showWhenStarting', False)
browser.profile.set_preference('browser.download.dir', 'C:\\Dropbox\\ProgramData\\eclipse-jee-luna\\DATAS_Code\\Pig_Scraper\\output')
browser.profile.set_preference("browser.helperApps.neverAsk.saveToDisk", "application/zip, application/x-zip, application/x-zip-compressed, application/download, application/octet-stream")
...
'''
button_click('//input[@value="Download in CSV Format"]', 'xpath')
#download_url = browser.find_element_by_xpath('//input[@value="Download in CSV Format"]').get_attribute('href')
#download_url = browser.find_element_by_xpath('//input[@value="Download in CSV Format"]')
#urllib.urlretrieve(download_url, 'C:\\Dropbox\\ProgramData\\eclipse-jee-luna\\DATAS_Code\\Pig_Scraper\\output\\pig.zip')
#print download_url
