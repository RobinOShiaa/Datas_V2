...
yearlist<-c("2015","2016")
#yearlist<-c("201510","201511", "201512","201601","201602")
HS_option<-"02"
animal_year<-"pig_2015"
...
headers<-c('Classification','Year','Period','Period Desc.','Aggregate Level',	'Is Leaf Code',	'Trade Flow Code','Trade Flow',	'Reporter Code','Reporter','Reporter ISO',	
           'Partner Code','Partner','Partner ISO','Commodity Code',	'Commodity',	'Qty Unit Code',	'Qty Unit',	'Qty','Netweight (kg)',	'Trade Value (US$)',	'Flag')
