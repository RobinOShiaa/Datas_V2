...
def scrape(db_params):
    ...
    #url = 'http://www.bpex.org.uk/prices-facts-figures/production/AnnualGBcleanpigslaughterings%20(2).aspx'
    url = 'http://pork.ahdb.org.uk/prices-stats/production/gb-slaughterings/annual-clean-pig/'
    ...
    file_path = '%sannual_clean_pig_slaughterings_historical.csv' % dir
    ...
    # source_file = '/users/suzanne/downloads/cleanpigslaughterings.xls'
    # dest_file = BPEX_PATH + 'historical/annual_clean_pig_slaughterings_historical.xls'
