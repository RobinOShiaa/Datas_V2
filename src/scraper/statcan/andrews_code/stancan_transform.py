...
strtime=str(datetime.datetime.now().time())
...
infile1='C:/Users/Andrew/Google Drive/scrape_output/Pig/Trade/statcan/statcan_1_new.csv'
infile2='C:/Users/Andrew/Google Drive/scrape_output/Pig/Trade/statcan/statcan_2_new.csv'
...
columnlist=['CountryId','hs_code','Date','Unit','Value']
...
merge=pd.merge(DataQty,DataVal[['Date','hs_code','CountryId','Value']],how='outer',on=['Date','hs_code','CountryId'])
print merge
...
if os.path.exists('C:/Users/Andrew/Google Drive/scrape_output/Pig/Trade/statcan/all 02s FAO Andrew/'
              + strdate[0:4] + '_' + strdate[5:7] + '_' + strdate[8:10] +  '/') ==True:                
    output.to_csv('C:/Users/Andrew/Google Drive/scrape_output/Pig/Trade/statcan/all 02s FAO Andrew/'
