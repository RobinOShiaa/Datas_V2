...
class AnnualCleanPigSlaughteringsHistorical(ChromeScraper):

    logger = get_logger("AnnualCleanPigSlaughteringsHistorical")

    def scrape(self):
        self.logger.info("Starting")
        self.url = "http://pork.ahdb.org.uk/prices-stats/production/gb-slaughterings/annual-clean-pig/"

        tmp_path = self.CSV_FOLDER_PATH + "/cleanpigslaughterings.xls"
        ...
        df.to_csv(self.CSV_FOLDER_PATH + "/annual_clean_pig_slaughterings_historical.csv",
        ...
        # Update tmp_path
        tmp_path = self.CSV_FOLDER_PATH + "/annual_clean_pig_slaughterings_historical.csv"
        ...
        with open(tmp_path, "r") as f:
            ...
            with open(tmp_path, "w+", newline="", encoding="utf-8") as f:
                ...
                writer.writerow(["Year", "Footnotes", "Annual GB Clean Pig Slaughterings ('000 head)"])
