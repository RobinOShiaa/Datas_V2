...
class milk_settlements(ChromeScraper):

    def __init__(self,url = 'https://www.cmegroup.com/trading/agricultural/grain-and-oilseed/corn_quotes_settlements_futures.html',CSV_FOLDER_PATH = None):
...
#[print(i.text) for i in self.driver.find_elements_by_xpath('//*[@id="settlementsFuturesProductTable"]/tbody/tr/th/td')]


    def to_csv(self):

        with open(self.CSV_FOLDER_PATH + '/corn_future.csv', "w+", newline="") as f:
