...
class lean_hog(ChromeScraper):



    def __init__(self, url = 'https://www.cmegroup.com/trading/agricultural/livestock/lean-hogs.html', CSV_FOLDER_PATH=None):
    ...
    def to_csv(self):
        ...
        with open(self.CSV_FOLDER_PATH + '/Lean_Hog.csv', "w+", newline="") as f:
