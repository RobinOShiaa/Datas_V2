...
class milk_settlements(ChromeScraper):
    ...
    def __init__(self,url = 'https://www.cmegroup.com/trading/agricultural/dairy/class-iii-milk_quotes_settlements_futures.html',CSV_FOLDER_PATH = None):
...
#[print(i.text) for i in self.driver.find_elements_by_xpath('//*[@id="settlementsFuturesProductTable"]/tbody/tr/th/td')]
    ...
    def to_csv(self):
        ...
        with open(self.CSV_FOLDER_PATH + '/milk_sett.csv', "w+", newline="") as f:
