...
class Eurostat_Milk_Dairy(ChromeScraper):


    def __init__(self, url=('https://ec.europa.eu/eurostat/estat-navtree-portlet-prod/BulkDownloadListing?sort=1&downfile=data%2Fapro_mk_pobta.tsv.gz'), CSV_FOLDER_PATH=None):
